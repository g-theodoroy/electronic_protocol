...
class ProtocolController extends Controller
{
    ...
    public function index( Protocol $protocol){
        ...
        return view('protocol', compact('fakeloi', 'protocol', 'newetos', 'currentEtos', 'newprotocolnum', 'newprotocoldate', 'in_date', 'out_date', 'diekp_date', 'class', 'protocoltitle', 'protocolArrowStep', 'submitVisible','delVisible', 'ipiresiasName', 'readonly'));
    }


    public function getFileInputs($num, $fakelos){
    	...
    	return view('getFileInputs', compact('num', 'years', 'words', 'keepval', 'allowUserChangeKeepSelect', 'data'));
    }
    ...
    public function store(){
      ...
      $filescount = 2 * $data['file_inputs_count'];
