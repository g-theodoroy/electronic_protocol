        ...
        <div class="panel panel-default col-md-12 col-sm-12  ">
            <div class="row bg-warning">
                ...
                <div class="form-control-static col-md-2 col-sm-2 ">
                    {{ \Carbon\Carbon::parse($mailMessage->getHeader(HeaderConsts::DATE)->getDateTime())->timezone(App\Config::getConfigValueOf('timeZone'))->format('d/m/Y H:i:s') }}
                </div>
            </div>
            <div class="row bg-warning ">
            ...
            @if (strlen($mailMessage->getTextContent()))
                <div class="row">
                    <div class="form-control-static col-md-12 col-sm-12  small"
                        style="white-space: pre-wrap; overflow: hidden">{{ $mailMessage->getTextContent() }}</div>
                </div>
            @endif
            <hr>
