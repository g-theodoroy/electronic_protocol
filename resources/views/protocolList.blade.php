                                            ...
                                            <li>
                                                @if ($attachment->name)
                                                    <a href='{{ URL::to('/') }}/download/{{ $attachment->id }}'
                                                        ...
                                                        @if (strlen($attachment->name) > 13)
                                                            {{ mb_substr($attachment->name, 0, 3, 'utf-8') }}...{{ mb_substr($attachment->name, -7, 7, 'utf-8') }}@else{{ $attachment->name }}
                                                        @endif
                                                    </a>
                                                @endif
                                                ...
                                                @if ($attachment->ada)
                                                    <a href='{{ $diavgeiaUrl }}{{ $attachment->ada }}' target="_blank"
                                                        ...
                                                        @if (strlen($attachment->ada) > 13)
                                                            {{ mb_substr($attachment->ada, 0, 3, 'utf-8') }}...{{ mb_substr($attachment->ada, -3, 3, 'utf-8') }}@else{{ $attachment->ada }}
                                                        @endif
                                                    </a>
                                                @endif
                                            </li>
