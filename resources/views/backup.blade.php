                        ...
                        <div class="panel panel-default col-md-12 col-sm-12  ">
                            ...
                            <div class="row">
                                @if (env('DB_CONNECTION') == 'sqlite')
                                    <div
                                        class="form-control-static text-left col-md-8 col-sm-8  col-md-offset-1 col-sm-offset-1">
                                        {{-- <a href="{{ URL::to('/') }}/backup"  role="button" title="Δημιουργία αντιγράφου ασφαλείας" > <img src="{{ URL::to('/') }}/images/save.ico" height="30" /></a> --}}
                                        Το Ηλεkτρονικό Πρωτόκολλο χρησιμοποιεί την <strong>sqlite</strong> σαν βάση
                                        δεδομένων. Αν θέλετε να κρατήσετε αντίγραφα ασφαλείας μπορείτε:
                                        <ul>
                                            <li>Να αντιγράψετε όλο τον φάκελο του Ηλ. Πρωτοκόλλου:
                                                <strong>"{{ dirname(base_path()) }}"</strong>
                                            </li>
                                            <li>Να αντιγράψετε τη βάση δεδομένων και τα συνημμένα αρχεία που περιέχονται
                                                στον φάκελο: <strong>"{{ storage_path() }}\app\arxeio"</strong></li>
                                        </ul>
                                    </div>
                                @else
                                    <div
                                        class="form-control-static text-center col-md-2 col-sm-2  col-md-offset-5 col-sm-offset-5">
                                        <a href="{{ URL::to('/') }}/backup" role="button"
                                            title="Δημιουργία αντιγράφου ασφαλείας"> <img
                                    ...
                                    <div class="form-control-static text-center col-md-12 col-sm-12  ">
                                        ...
                                        <ul class='list'>
                                            @foreach ($files as $file)
                                                <li>
                                                    <a
                                                        href='{{ URL::to('/') }}/downloadBackup/{{ $file['basename'] }}'>{{ $file['basename'] }}</a>
                                                    <a href="#" id='delbackup' title="Διαγραφή {{ $file['basename'] }}"
                                                        onclick="chkdelete('{{ $file['basename'] }}')"> <img
                                                            src="{{ URL::to('/') }}/images/delete.ico" alt="delete"
                                                            height="15"> </a>
                                                </li>
                                            @endforeach
                                        </ul>
