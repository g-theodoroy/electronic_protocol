            ...
            <table class="table table-condensed table-bordered">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="small middle"><span class='small'>Περίλ.Εισερχ.<br>&#x2727; Περίλ.Εξερχ.</span>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($arxeia as $arxeio)
                        <tr>
                            ...
                            <td class="small middle">
                                <span class='small'>{{ $arxeio->protocol->protocoldate ?? null }}</span>
                            </td>
                            <td class="small middle"><span class='small'>{{ $arxeio->expires }}</span></td>
                            <td class="small middle">
                                @if ($arxeio->name)
                                    <span class='small'>{{ $arxeio->name }}</span>
                                @endif
                                @if ($arxeio->name and $arxeio->ada)
                                    <br>
                                @endif
                                @if ($arxeio->ada)
                                    <span class='small'>ΑΔΑ:{{ $arxeio->ada }}</span>
                                @endif
                            </td>
                            <td class="small middle"><span
                                    class='small'>{{ $arxeio->protocol->thema ?? null }}</span>
                            </td>
                            <td class="small middle">
                                <span class='small'>
