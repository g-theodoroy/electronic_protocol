                        ...
                        <div class="panel-body ">
                            <div class="panel panel-default col-md-12 col-sm-12  ">
                                <div class="row bg-warning">
                                    <div class="form-control-static h4 text-center">Ομάδα δημιουργίας του Ηλ.Πρωτοκόλλου
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 text-justify">
                                        <h4 class="text-center">
                                            Γεώργιος Θεοδώρου
                                            <a href="mailto:g.theodoroy@gmail.com?subject=Ηλ.Πρωτόκολλο"
                                                title="Αποστολή email">
                                                <img src="{{ URL::to('/') }}/images/email.png" height=15
                                                    alt="Αποστολή email" />
                                            </a>
                                        </h4>
                                        <p>
                                    ...
                                    <div class="col-md-6 col-sm-6 text-justify">
                                        ...
                                        <p>
                                            ...
                                            Με την μεγάλη του διοικητική εμπειρία βοήθησε τα μάλα στον σχεδιασμό του
                                            project.
                                            Επιμελήθηκε τους Φακέλους Φ. καθώς και το χρόνο διατήρησης των αρχείων.
                                        </p>
                                    </div>
                                    <div class="col-md-12 col-sm-12 text-justify">
                                        Πολύτιμη ήταν η συμβολή μελών της κοινότητας <a
                                            href="http://alkisg.mysch.gr/steki/index.php?topic=6958.0" target="_blank">Το
                                            Στέκι των Πληροφορικών</a> που με τις ιδέες και
                                        τις προτάσεις τους ραφινάρισαν το project...
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <h4 class="text-center bg-warning">Εύσημα...</h4>
                                        <p>
                                            Το Ηλ. Πρωτόκολλο είναι διαδικτυακή εφαρμογή. Είναι γραμμένη σε γλώσσα PHP και
                                            χρησιμοποιεί
                                            τα μοντέρνα framework <a href="https://laravel.com/"
                                                target="_blank"><strong>Laravel</strong></a>,
                                            <a href="http://getbootstrap.com/"
                                                target="_blank"><strong>Bootstrap</strong></a>,
                                            τη βιβλιοθήκη javascript <a href="https://jquery.com/"
                                                target="_blank"><strong>jQuery</strong></a>, ...
                                        </p>
                                        <h4 class="text-center bg-warning">Αποποίηση ευθυνών</h4>
                                        <p>
                                            Παρέχεται "ώς έχει" σύμφωνα με τη "Γενική Άδεια Δημόσιας Χρήσης GNU".
                                            Τακτικά backup θα προστατέψουν τα δεδομένα σας. Η ομάδα δημιουργίας δεν φέρει
                                            καμιά ευθυνη
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 text-center form-control-static">
                                        <form action="https://www.paypal.com/donate" method="post" target="_top">
                                            ...
                                            <img alt="" border="0" src="https://www.paypal.com/en_GR/i/scr/pixel.gif"
                                                width="1" height="1" />
                                        </form>
                                    </div>
                                </div>
