...
@section('content')
            ...
            <div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body ">
                        ...
                        <form id='printform' name="printform" class="form-horizontal" role="form" method="POST"
                            action="{{ url('/printed') }}" target='_blank'>
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3  col-md-offset-1 col-sm-offset-1" id="aponumdiv">
                                        <input id="aponum" type="text" class="form-control text-center" name="aponum"
                                            placeholder="από" value=""
                                            title='Από αριθμό πρωτοκόλλου. Κενό = από τον πρώτο.'>
                                    </div>
                                    <div class="col-md-3 col-sm-3  " id="eosnumdiv">
                                        <input id="eosnum" type="text" class="form-control text-center" name="eosnum"
                                            placeholder="έως" value=""
                                            title='Έως αριθμό πρωτοκόλλου. Κενό = έως τον τελευταίο.'>
                                    </div>
                            ...
                            <div class="col-md-2 col-sm-2 col-md-offset-3 col-sm-offset-3 text-center">
                                <a href="" onclick="document.forms['printform'].reset();" role="button" title="Καθαρισμός">
                                    <img src="{{ URL::to('/') }}/images/clear.ico" height="30" /></a>
                            </div>
                            <div class="col-md-2 col-sm-2 text-center ">
                                <a href="#" onclick="getPrintData()" class="" role="button" title="Εκτύπωση">
                                    <img src="{{ URL::to('/') }}/images/print.png" height="30" /></a>
                            </div>
                            <div class="col-md-2 col-sm-2 text-center ">
                                <a href="#" onclick="getPrintData('xls')" class="" role="button"
    ...
    <script>
        ...
        function getPrintData(target = null) {
            ...
            var chk_novalue = $("#aponum").val() + $("#eosnum").val() + $("#etosForMany").val() + $("#apoProtocolDate")
                .val() + $("#eosProtocolDate").val()
            if (!chk_novalue) {
