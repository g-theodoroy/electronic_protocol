    ...
    <div class="row ">
      <div class="col-md-2 col-sm-2 small form-control-static ">
        <input id="ada{{$k}}" type="text" name="ada{{$k}}" class="form-control input text-center" placeholder="ΑΔΑ" title="Επιλέξτε αρχείο ή πληκτρολογείστε ΑΔΑ">
      </div>
      <div class="col-md-2 col-sm-2">&nbsp;</div>
      <div class="col-md-2 col-sm-2 small form-control-static ">
        <input id="ada{{$k+1}}" type="text" name="ada{{$k+1}}" class="form-control input text-center" placeholder="ΑΔΑ"  title="Επιλέξτε αρχείο ή πληκτρολογείστε ΑΔΑ">
      </div>
      <div class="col-md-2 col-sm-2">&nbsp;</div>
      <div class="col-md-2 col-sm-2 small form-control-static ">
        <input id="ada{{$k+2}}" type="text" name="ada{{$k+2}}" class="form-control input text-center" placeholder="ΑΔΑ"  title="Επιλέξτε αρχείο ή πληκτρολογείστε ΑΔΑ">
      </div>
      <div class="col-md-2 col-sm-2">&nbsp;</div>
    </div>
    @php($k+=3)
